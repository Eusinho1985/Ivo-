...
// configuration step. It creates a namespace called `Ivo_`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Ivo_::cmake::project_name, Ivo_::cmake::project_version) };
